...
export const en: Dict = {
  ...
  'settings.controlKeyHint':
    'Control keys (tch_ctl_*) authenticate this console and the management MCP.',
  'settings.accessKeys': 'Access Keys',
  'settings.accessKeyHint':
    'Access keys (tch_mcp_*) authenticate the MCP data plane. Control keys authenticate this console.',
